...
enum LockerType
{
    ...
    private LockerType(int lockerSize)   {
...
public class Locker
{
    ...
    public int localId;
    public Locker(int id, LockerType type)
    {
        lockerId = id;
        this.type = type;
    }
    public Locker(int id, LockerType type, int localId)
    {
        this.lockerId = id;
        this.type = type;
...
{
    private int lockerManagerId;
    private HashMap<Locker, Integer> lockers;
